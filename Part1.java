...
public class Part1
{
    ...
    public void run ()
    {
        ...
        pythagDistance = computePythagDistance (start, end);

        System.out.println ("The distance between a and b is: " + distance);
    }

    public double computePythagDistance (Point a, Point b) {
    ...
    public String toString (Point a, Point b){
        System.out.println("The distance from point " + start + " to point " + end + " is " + distance);
    ...
    public Point readPoint () {
        ...
        public double setX(double newPoint){
